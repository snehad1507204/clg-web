      ...
      <footer className="footer">
        <div className="footer-container">
          <div className="footer-col footer-branding">
            ...
            <p className="tagline">Unlocking potential through education.</p>
          </div>
          <div className="footer-col">
            ...
            <ul className="quick-links">
              ...
              <li><a href="/courses" data-link>Courses</a></li>
              <li><a href="/free-courses" data-link>Free Courses</a></li>
          ...
          <div className="footer-col contact-info">
            <h3>Contact Us</h3>
            <p><i className="fa-solid fa-location-dot"></i>Sw. Narendra Singh Mahavidyalaya, Gajner, Kanpur Dehat.</p>
            <p>Adjacent to the Gajner Police Station.</p>
            <p><i className="fa-solid fa-phone"></i> <a href="tel:+918851955753">+91 8851955753</a> <a href="tel:+918851955596">+91 8851955596</a></p>
            <p><i className="fa-solid fa-envelope"></i> <a href="mailto:snsmv25@gmail.com">snsmv25@gmail.com</a></p>
          </div>

          <div className="footer-col">
            <h3>Follow Us</h3>
            <div className="footer-col social-media-icons">
              <a href="https://www.facebook.com/Sw.NarendraSinghMahavidyalaya" className="social-icon"><i className="fa-brands fa-facebook-f"></i></a>
              <a href="https://youtube.com/@snsmv?si=lhWDf7UR4A5-b36l" className="social-icon"><i className="fa-brands fa-youtube"></i></a>
              <a href="https://www.instagram.com/swnarendrasinghmahavidyalaya?igsh=MXNuYjhtcmgwZTk0dg==" className="social-icon"><i className="fa-brands fa-instagram"></i></a>
              <a href="https://www.linkedin.com/in/sw-narendra-singh-mahavidyalaya-83587a380?lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base%3BCMzBn0v%2FRyK%2FAKiaYT6PuQ%3D%3D" className="social-icon"><i className="fa-brands fa-linkedin"></i></a>
            </div>
          </div>
        </div>
        <div className="footer-bottom">
          <div className="copyright-container">
            <p>&copy; 2023 Sw. Narendra Singh Mahavidyalaya. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </>
